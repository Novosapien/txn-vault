...
| Date | What happened |
|------|--------------|
| 2026-06-09 | [[co-pilot]] taken to buildable sub-component depth (pilot): [[guided-onboarding]], [[guided-configuration]], [[conversational-qa]] written from their UX journeys with entity journeys + acceptance criteria. 3 of 6 Co-pilot sub-components now **Defined**. |
