---
description: "Three buyer personas for ICP 2, new program with the incumbent staying: the product lead the platform has boxed in, the engineer facing two stacks, and the CFO comparing against a price already paid"
---

# Buyer Personas: ICP 2, new program, incumbent stays
...
**The rule that governs every message to all three.** Never go after the incumbent, named, implied or by category. The incumbent stays in place and keeps the original book, so this buyer is standing behind a live decision they are not reversing, and criticising it criticises them. State what TXN does. Never state what the other cannot. Let the buyer draw the comparison, because they already have.

**One persona carries a flag.** The ICP records the CTO's weight in this buying group as genuinely open, because ICP 2 is the only situation where a client ends up running two processors in parallel. That either makes the CTO the most consequential person in the deal or barely involves them, and Ian's experience decides it. The persona is built in full and the weighting question is carried to the gaps list rather than guessed at.

---

## Persona 2.1: CPO or Head of Product (Champion, leads the deal)
...
- **Core Values / What They Optimise For:** Freedom of movement. Their measure of a platform is how much of the roadmap it silently forbids.
- **How They Measure Their Own Worth:** By whether the product they described a year ago is the product that exists, and by how much of the gap was their choice rather than someone else's limit.
- **Worldview & Biases Toward This Category:** Knows the category well enough to be unimpressed and to be specific. Has learned that platform capability is discovered after signature, not during evaluation, and now asks about the second and third version rather than the first.

**4.0 A Day in the Life**
I know exactly what I want to build and I know exactly why I cannot build it here, which is a more frustrating position than not knowing. We asked, we got a considered answer, and the answer was a roadmap item with no date. So now I am running a second evaluation two years after the first one, and this time I am not asking what the platform can do. I am asking what it cannot, and getting the same evasive shapes I got last time. This morning I mapped the new proposition against what our current setup supports and drew a line through four of nine features, and none of those four are exotic. My own team keeps asking why we do not just wait, and the honest answer is that waiting has no end date attached to it. Meanwhile the commercial team has a partner agreement with a card in it and a date on it, and that date does not care which platform it lands on.

**5.0 Pains & Fears (Expanded Dossier)**

**5.1 Operational Pains (Daily Fires)**
- **"The platform decides what we are allowed to build, and nobody chose that."** My roadmap is being shaped by somebody else's backlog and I did not agree to it.
- **"I get roadmap items instead of dates, and a roadmap item is not a commitment."** It is a way of saying no that survives the meeting.
- **"Every new market turns out to need something the current setup does not do."** It is never the big thing. It is a control, a fee structure, a BIN arrangement, and it stops the whole launch.
...
- **Tried to build the missing capability on their own side, around the platform.** Produced something fragile that worked for one case and did not generalise, and now needs maintaining.
- **Escalated commercially, at renewal.** Improved the price, changed nothing about the capability, which taught them the constraint is architectural rather than negotiable.
- **Scoped the new product down to fit what the platform supports.** The scoped-down version tested badly with the people it was for, which is what moved this from a preference to a decision.
...
- **Objections / sources of resistance:**
  - "We already have a processor and it works. Explain why this is not just complexity."
  - "You will tell me you support it. Everyone told me that last time. How do I check?"
  - "What happens to us when the thing we need next is not on your platform either?"
...
- Reachable by a message that names a specific new market or product they have publicly signalled, and connects it to what that requires.

**10.0 Success Metrics (What "Good" Looks Like)**
- From a roadmap shaped by someone else's limits, to one where the constraint is their own capacity.
- From a new market being a vendor negotiation, to a new market being configuration and a BIN arrangement.
- From scoping products down to fit the platform, to building the version that tested well.
...
## Persona 2.2: CTO or Head of Engineering (Approver, weighting unconfirmed)

**1.0 Archetype Name** The Two-Stack Owner

**2.0 Role & Functional Identity**
- **2.1 Primary Function:** Owns the engineering consequence of a decision made on product grounds: two processors, two integrations, two reconciliations, one team.
- **2.2 Core Responsibilities:**
...
**3.0 Psychographic Profile**
- **Identity & Self-Image:** The person who carries the operational reality of decisions taken elsewhere, and who has stopped being surprised by that.
- **Core Values / What They Optimise For:** Total system cost over time, not project cost. They are the only person in the room thinking about year three.
- **How They Measure Their Own Worth:** By whether the estate stays comprehensible. Two of anything is a comprehension cost, and they are the one who pays it.
- **Worldview & Biases Toward This Category:** Has integrated a processor before, so they know exactly how long the last 20 per cent takes and exactly which parts of the documentation will turn out to be aspirational. Sceptical of anything described as easy by someone who has not maintained it.

**4.0 A Day in the Life**
Everyone is discussing which platform and I am the only one costing what happens afterwards. We will have two of everything. Two integrations, two reconciliations, two sets of scheme reporting, two places to look when a number does not match, and the same people doing all of it. Nobody has asked me whether that is fine, they have asked me how long it takes, which is a different question with a much more comfortable answer. This afternoon I have to give product an estimate, and the honest version has a large number in it for work that is not integration at all, it is the internal abstraction we wrote against one vendor's model and will now have to generalise. I have been through a card integration before. I know the shape of it. What I do not know is what running two feels like in month nine, and neither does anyone I have asked.

**5.0 Pains & Fears (Expanded Dossier)**

**5.1 Operational Pains (Daily Fires)**
- **"We are about to have two of everything and one team."** Two reconciliations, two escalation paths, two mental models. That is the real cost and it does not appear in any business case.
- **"Our internal abstraction was written against one vendor and it shows."** Half the integration work is not integration, it is undoing an assumption we made three years ago.
- **"I am being asked how long, not whether."** The decision arrives as a schedule question, which is how the ongoing cost gets skipped.
...
- **Pushed the capability request into the incumbent's roadmap process, with engineering weight behind it.** Got a fair hearing and a queue position, which resolved nothing on any timeline they could plan against.
- **Estimated building the missing capability in-house.** The build was plausible; the ongoing scheme mandate work was not, and that is what closed it.
- **Asked peers running two processors what it actually costs.** Found very few people who had done it, and the ones who had gave answers that were more discouraging than the business case assumes.

**7.0 Decision Criteria & Objections**
- **What they weigh evaluating this category:**
  - Whether the API surface is complete enough that the second integration does not require screen-based workarounds.
  - Whether sandbox and production genuinely behave the same, because they will be testing against it while running something else in production.
  - What the reconciliation and reporting surface looks like, since that is where the duplicated cost actually lives.
  - Whether operations can self-serve, because every configuration change that needs engineering doubles in a two-platform world.
- **Objections / sources of resistance:**
...
**9.0 Information Diet & Trusted Voices**
- Engineering peers who have genuinely run two processors, who are rare enough that finding one is itself an event.
- Developer portals and sandboxes, used as the primary evidence about a vendor's seriousness.
- Public status pages and incident histories, watched over months rather than checked once.
- Internal evidence above all: their own reconciliation breaks, their own on-call load, their own team's estimates.
- Reachable only through technical specificity. A message about growth or transformation is deleted; a message about API completeness or reconciliation surface is read.
...
## Persona 2.3: CFO or Finance Director (Economic Buyer, approves)

**1.0 Archetype Name** The Second Invoice
...
**3.0 Psychographic Profile**
- **Identity & Self-Image:** The person who makes sure the company knows what it is spending and why. Not a blocker, a scorekeeper who insists the score is real.
- **Core Values / What They Optimise For:** Defensibility. Every number they present has to survive the question underneath it.
- **How They Measure Their Own Worth:** By whether the forecast holds. A commitment that behaves as modelled is a success even if it is expensive.
- **Worldview & Biases Toward This Category:** Understands processing economics well enough to know that headline rates are not the cost, and that the differences between vendors show up at volumes nobody quotes for. Structurally biased against adding a supplier, which is a policy position rather than an opinion.

**4.0 A Day in the Life**
I am being asked to approve a second supplier in a category where we already have one, and the burden of proof for that is high and it should be. My first question is always the same and it is not about price, it is why the existing arrangement does not cover this, and I have now had that answer three times from three people and I believe it. What I do not have is a comparison, because the only rate card I understand is the one I already pay, and I am being asked to evaluate a structure without figures against a structure with two years of invoices behind it. The business case is genuinely optional. Nothing breaks if we do not do this, which means I am funding upside, and upside is the first thing cut when the quarter is tight. I also know that the day I sign this, we own two renewal cycles and two sets of minimums, and that is a permanent piece of administration nobody has costed.

**5.0 Pains & Fears (Expanded Dossier)**

**5.1 Operational Pains (Daily Fires)**
- **"I am comparing an unpriced structure to an invoice I have paid twenty-four times."** That is not a like-for-like comparison and everyone in the conversation knows it.
- **"The business case is optional, so it is the first thing that dies in a tight quarter."** I have to fund upside, and upside always loses to necessity.
- **"Two contracts is two renewals, two minimums and two sets of commercial administration."** Small individually, permanent collectively, and never in anybody's model.
...
**9.0 Information Diet & Trusted Voices**
- Their own invoices, above every other source. Two years of real data beats any vendor's model.
- Finance peers at comparable companies, for the one thing vendors will not provide, which is what other people actually pay.
- The board and its operators, whose view on vendor concentration shapes the policy this decision runs into.
- Almost no vendor content. This persona reads contracts, not collateral.
- Reachable by brevity and specificity, and by an approach that opens on the commercial structure rather than the product.
