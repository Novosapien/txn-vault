...
- Every interaction offers a **feedback path** classified automatically as **bug / product enhancement / support request / sales enquiry** and routed to the correct internal queue.
...
| Defensive triage + routing | Build | Confidence gating → classify (bug/enhancement/support/sales) → internal queue | Hands off to [[internal-ops-agents]] for triage/resolution |
...
| Classified feedback | Out | Internal queues ([[internal-ops-agents]]) / sales team | bug / enhancement / support / sales |
...
- **Feedback routing** — auto-classify bug/enhancement/support/sales → right internal queue (differential handling per type)
- **Support-ticket surfacing** — reuse known answers from existing tickets
