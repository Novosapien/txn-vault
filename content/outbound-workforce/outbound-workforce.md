...
| **Deliverability** | DKIM, DMARC and SPF on TXN's sending domains, then warming | **Not started.** Booked for 1 or 2 September |
...
| **Tue 1 or Wed 2 Sep** | **Technical: email domains and warming** | **To book.** With **Jacob**, TXN's domain administrator. Sets up the sending domains, DKIM, DMARC and SPF, and starts the warming clock |
| **w/c 1 Sep** | **Team login and platform setup** | **To book.** Gets the TXN team into the Outbound Workforce platform and set up |
...
| Jacob | TXN domain administration. Needed for the deliverability build |
