...
|---------|-------------|--------|
| **The workflow slate has been reviewed and TXN is aligned.** Michael: *"I went through it last week. I'm fairly happy with what you've sent across... they're very much aligned to what we want to do."* He meets Ian straight after this call to agree **the priority order** and will send the list back. **The blocker recorded on 19 August is resolving** | [[open-questions]] #61, [[delivery]] | Register row updated |
